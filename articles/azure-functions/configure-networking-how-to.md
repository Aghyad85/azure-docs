...
1. Update the **Application Settings** under **Configuration** for the function app to the following:
    ...
    | `WEBSITE_CONTENTOVERVNET` | 1 | A value of 1 enables your function app to scale when you have your storage account restricted to a virtual network or private endpoint. You should enable this setting when restricting your storage account to a virtual network or private endpoint.|
